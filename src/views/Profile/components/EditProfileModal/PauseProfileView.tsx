...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from '@pieswap-libs/uikit'
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss }) => {
  ...
  const { numberPieToReactivate } = useGetProfileCosts()
  const TranslateString = useI18n()
  const pieProfileContract = useProfileContract()
  ...
  return (
    <>
      ...
      <Text as="p" color="textSubtle" mb="24px">
        {TranslateString(999, `Cost to reactivate in future: ${getBalanceNumber(numberPieToReactivate)} PIE`)}
      </Text>
