...
import { AutoRenewIcon, Button, Card, CardBody, Heading, Skeleton, Text } from '@pieswap-libs/uikit'
...
import { usePieRabbits } from 'hooks/useContract'
...
const ProfilePicture: React.FC = () => {
  ...
  const handleApprove = () => {
    pieRabbitsContract.methods
      .approve(getPieProfileAddress(), tokenId)
      .send({ from: account })
      .on('sending', () => {
        setIsApproving(true)
      })
    ...
    return (
      <>
        ...
        <Text as="p">
          {TranslateString(
            856,
            'You need a Pie Collectible to finish setting up your profile. If you sold or transferred your starter collectible to another wallet, you’ll need to get it back or acquire a new one somehow. You can’t make a new starter with this wallet address.',
          )}
        </Text>
      </>
    )
      ...
      <Card mb="24px">
        <CardBody>
          ...
          <Text as="p" color="textSubtle" mb="24px">
            {TranslateString(816, 'Only approved Pie Collectibles can be used.')}
