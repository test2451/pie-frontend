...
import { Heading, Card, CardBody, CardFooter, Text, PieRoundIcon, Flex, Skeleton } from '@pieswap-libs/uikit'
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} PIE</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>
